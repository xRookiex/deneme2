...
let verifyroless = message.guild.roles.find(`name`, "＊ Kural Yokos Commanders");
...
let verifyrole = message.guild.roles.find(`name`, "🎩 | Helios");
if (!verifyrole) return message.reply("Rol Bulunamadı Lütfen '🎩 | Helios' Adıyla Rol Oluşturunuz.");
